...
import { DecodeError, DecodeErrorMessage, decodeHeader, } from "../header.js";
 ...
 */
export function deserialize(tabString, documentType) {
    ...
    const contact = (contactName || contactTelephone || contactEmail)
        ? {
            name: contactName,
    ...
    const singleInvoiceLine = hasSingleLine
        ? {
...
export function decode(qr) {
    ...
    return deserialize(decoded, headerData.documentType);
}
