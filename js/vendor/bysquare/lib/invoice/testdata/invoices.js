import { InvoiceDocumentType, PaymentMean, } from "../types.js";
export function buildSupplierParty(overrides) {
    return {
...
export function buildTaxCategorySummary(overrides) {
    return {
...
export function buildInvoiceDataModel(overrides) {
    return {
...
export const INVOICE_FIXTURE = buildInvoiceDataModel();
export const INVOICE_WITH_SINGLE_LINE = buildInvoiceDataModel({
...
export const INVOICE_WITH_FOREIGN_CURRENCY = buildInvoiceDataModel({
    foreignCurrencyCode: "USD",
    currRate: 1.08,
    referenceCurrRate: 1,
});
export const INVOICE_WITH_ALL_FIELDS = buildInvoiceDataModel({
...
export const PROFORMA_INVOICE_FIXTURE = buildInvoiceDataModel({
    documentType: InvoiceDocumentType.ProformaInvoice,
    invoiceId: "PF2024001",
});
export const CREDIT_NOTE_FIXTURE = buildInvoiceDataModel({
    documentType: InvoiceDocumentType.CreditNote,
    invoiceId: "CN2024001",
});
export const DEBIT_NOTE_FIXTURE = buildInvoiceDataModel({
    documentType: InvoiceDocumentType.DebitNote,
    invoiceId: "DN2024001",
});
export const ADVANCE_INVOICE_FIXTURE = buildInvoiceDataModel({
 ...
 */
export const FORSYS_INVOICE_FIXTURE = {
    documentType: InvoiceDocumentType.Invoice,
    invoiceId: "201300001",
    issueDate: "20130227",
...
export const ROUND_TRIP_INVOICE_TEST_CASES = [
    INVOICE_FIXTURE,
