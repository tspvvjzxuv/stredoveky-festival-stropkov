...
import { decode, deserialize, } from "./decode.js";
import { encode, serialize, } from "./encode.js";
import { buildInvoiceDataModel, FORSYS_INVOICE_ENCODED, FORSYS_INVOICE_FIXTURE, INVOICE_FIXTURE, INVOICE_SERIALIZED, ROUND_TRIP_INVOICE_TEST_CASES, } from "./testdata/invoices.js";
...
describe("decode", () => {
    ...
    test("round-trip preserves all fields for full invoice", () => {
        ...
        expect(decoded.supplierParty.postalAddress.streetName).toBe(original.supplierParty.postalAddress.streetName);
        expect(decoded.supplierParty.postalAddress.country).toBe(original.supplierParty.postalAddress.country);
        ...
        expect(decoded.customerParty.partyIdentification).toBe(original.customerParty.partyIdentification);
        ...
        expect(decoded.singleInvoiceLine?.invoicedQuantity).toBe(original.singleInvoiceLine?.invoicedQuantity);
    ...
    test("decodes Forsys sample invoice from known QR string", () => {
        ...
        expect(decoded.singleInvoiceLine?.itemName).toBe("Vzorov\u00e1 fakt\u00fara pre \u0161tandard by square");
