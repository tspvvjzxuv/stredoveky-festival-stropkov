...
import { encode, removeDiacritics, serialize, } from "./encode.js";
import { buildDataModel, buildPaymentOrder, DIRECT_DEBIT_DATA, DIRECT_DEBIT_FIXTURE, DIRECT_DEBIT_SERIALIZED, MINIMAL_PAYMENT, PAYMENT_ORDER_FIXTURE, PAYMENT_ORDER_SERIALIZED, PAYMENT_ORDER_WITH_DIACRITICS_FIXTURE, PAYMENT_ORDER_WITHOUT_DIACRITICS_EXPECTED, STANDING_ORDER_DATA, STANDING_ORDER_FIXTURE, STANDING_ORDER_SERIALIZED, TEST_IBANS, VALID_PAYMENT_ORDER, } from "./testdata/index.js";
...
describe("date conversion", () => {
    ...
    test("should round-trip lastDate through encode/decode", () => {
        ...
        const encoded = encode(input);
        const decoded = decode(encoded);
        const standingOrder = decoded.payments[0];
