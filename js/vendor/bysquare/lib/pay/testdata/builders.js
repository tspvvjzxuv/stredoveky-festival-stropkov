...
import { TEST_AMOUNTS, TEST_CURRENCIES, TEST_IBANS, } from "./constants.js";
/**
 ...
 */
export function buildBankAccount(overrides) {
    return {
 ...
 */
export function buildPaymentOrder(overrides) {
    return {
 ...
 */
export function buildDataModel(overrides) {
    return {
