 ...
 */
export function validateSimplePayment(simplePayment, path, version = Version["1.2.0"]) {
    ...
    if (simplePayment.type === PaymentOptions.DirectDebit
 ...
 * @see ValidationError
 */
export function validateDataModel(dataModel, version = Version["1.2.0"]) {
