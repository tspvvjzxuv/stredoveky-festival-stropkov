...
import { DecodeError, DecodeErrorMessage, } from "../header.js";
import { decode, deserialize, } from "./decode.js";
import { encode } from "./encode.js";
import { buildDataModel, buildPaymentOrder, DECODE_TEST_CASES, DIRECT_DEBIT_DATA, DIRECT_DEBIT_FIXTURE, DIRECT_DEBIT_SERIALIZED, MINIMAL_PAYMENT, PAYMENT_ORDER_FIXTURE, PAYMENT_ORDER_SERIALIZED, PAYMENT_ORDER_WITH_DIACRITICS_FIXTURE, ROUND_TRIP_TEST_CASES, SERIALIZED_DATA_MISSING_IBAN, STANDING_ORDER_DATA, STANDING_ORDER_FIXTURE, STANDING_ORDER_SERIALIZED, TEST_IBANS, VALID_PAYMENT_ORDER, } from "./testdata/index.js";
...
describe("decode deserialization", () => {
    test("throws missing IBAN error", () => {
        ...
        expect(() => deserialize(serialized)).toThrow(new DecodeError(DecodeErrorMessage.MissingIBAN));
    });
    ...
    test("validates CRC32 checksum on decode", () => {
        ...
        const checksumValue = new DataView(checksum.buffer, checksum.byteOffset, 4).getUint32(0, true);
...
describe("round trip verification", () => {
    test.each(ROUND_TRIP_TEST_CASES)("$name", ({ data }) => {
